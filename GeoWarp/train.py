...
if __name__ == "__main__":
    ...
    # Test parameters
    parser.add_argument("--num_reranked_preds", type=int, default=20,
                        help="number of predictions to re-rank at test time") # TODO: probably this has to be changed to 5
    ...
    parser.add_argument("--datasets_folder", type=str, default="/content/small",
                        help="path with the datasets")
    parser.add_argument("--dataset_name", type=str, default="sf-xs",
    ...
    ss_dataset = dataset_warp.HomographyDataset(root_path=f"{args.datasets_folder}/train", k=args.k)
    ...
    for epoch in range(args.n_epochs):
        ...
        torch.save(homography_regression.state_dict(),
                   f"{output_folder}/checkpoints/homography_regression_{epoch:03d}.pth")
