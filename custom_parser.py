...
def parse_arguments(is_training: bool = True):
    ...
    # Custom arguments - START
    parser.add_argument("--test_dataset", type=str, default=None,
                        choices=["sf_xs", "tokyo_xs", "tokyo_night"], 
                        help="name of the dataaset to use as test set")
    # Custom arguments - END
    args = parser.parse_args()
    
    # Custom if statements - START
    if args.test_dataset is not None and not is_training:
        if args.test_dataset == "sf_xs":
            args.test_set_folder = "/content/small"
        elif args.test_dataset == "tokyo_xs":
            args.test_set_folder = "/content/tokyo_xs"
        else:
            args.test_set_folder = "/content/tokyo_night"
    
    elif args.dataset_folder is None:
        try:
