...
from CosPlace import test, parser, commons
from CosPlace.model import network
from CosPlace.datasets.test_dataset import TestDataset
...
queries_folder = "queries_v1" if args.test_dataset == "sf_xs" else "queries"
